...
if(isset($_POST['del'])) {
    ...
    $sql_delete = mysqli_query($connection, "DELETE FROM tblimportance_value WHERE ivID='$ivID'");
...
<head>
    ...
    <title>MMSG | Manage Importance Value</title>
...
<div class="container">
    ...
    <div>
        <a href="add-importance-value.php"><button style="margin-top: 20px; padding: 10px; " class="btn btn-success btn-md"><strong>Add Importance Value</strong></button></a>
        <a href="generate-importance-value-report.php"><button style="margin-top: 20px; padding: 10px; " class="btn btn-info btn-md"><strong>Generate Report</strong></button></a>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">Manage Importance Value</div>
                                    ...
                                    <td class="text-center"> 
                                        <div class="adjust-btn">
                                            <div style="padding-right: 5px;">    
                                                <a href="edit-importance-value.php?iv_id=<?php echo $row['ivID'];?>">
                                                    <button name="upd" class="btn btn-primary btn-sm"><i class="fa fa-edit "></i> Edit</button>
                                                </a>
                                            </div>


                                            <div>  
                                                <form method="post" action="manage-importance-value.php">
                                                    <input type="hidden" name="imva-id" value="<?php echo $row['ivID']; ?>">
                                                    <button type="submit" name="del" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i> Delete</button>
                                                </form>
                                            </div> 
                                        </div>
                                    </td>
