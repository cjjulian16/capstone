...
$sql = mysqli_query($connection, "INSERT INTO  tbllocation(FamilyName, LocalName, ScientificName, Category, Barangay, Municipality, mangroveimg, Longitude, Latitude) VALUES('$fname','$lname','$sname','$cat','$brgy','$muni','$locnewimage','$lng','$lat')");
...
<!-- MENU SECTION END-->
    <div class="container">
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Location </h4>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-success">
            <div class="panel-heading">Locations Info</div>
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lat" autocomplete="off"  required />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lng" autocomplete="off"  required />
                        </div>
                    </div>
...
<a href="manage-location.php"><button style="margin-top: 30px;" type="button" class="btn btn-info">Back</button></a>
