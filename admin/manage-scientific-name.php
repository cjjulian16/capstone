...
if(isset($_POST['del'])) {
    ...
    $sql_delete = mysqli_query($connection, "DELETE FROM tblscientific_name WHERE id='$id'");
...
<head>
    ...
    <title>MMSG | Manage Scientific Name</title>
...
<div class="container">
    <div class="row pad-botm">
        <div class="col-md-12">
            <h4 class="header-line">Manage Scientific Name</h4>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <?php 
                                    ...
                                    $sql = mysqli_query($connection, "SELECT * FROM tblscientific_name");
                                    ...
                                    <td class="text-center"> 
                                        <div class="adjust-btn">
                                            <div style="padding-right: 5px;">
                                                <a href="edit-scientific-name.php?sn_id=<?php echo $row['id'];?>">      
                                                    <button name="upd" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                            </div>


                                            <div>  
                                                <form method="post" action="manage-scientific-name.php">
                                                    <input type="hidden" name="msn-id" value="<?php echo $row['id']; ?>">
