...
<head>
    ...
    <title>MMSG | Mangrove Location</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">Mangrove Location</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        ?>
                                            ...
                                            <tr class="text-center bg-white" style="font-size: 11px;">
                                                ...
                                                <td width="150"><img style="height: 80px; width: 100px;" src="../admin/locationimage/<?php echo $row['mangroveimg'];?>"></td>
