...
<head>
    ...
    <title>MMSG | User Location Map</title>
...
<body>
    ...
    <a href="mangrove-location.php"><button style="margin: 20px;" class="btn btn-info" type="button">Back</button></a>
    ...
    var infoWindowContent = [
        <?php if(mysqli_num_rows($result2) > 0){
            while($row = mysqli_fetch_assoc($result2)){ ?>
                ...
                '<p><img style="height: 140px; width: 210px;" src="../admin/locationimage/<?php echo $row['mangroveimg'];?>"></p>' +
